...
<div style="max-width: 800px; margin: 0 auto; padding: 40px; text-align: center; background-color: #fdf2e9; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    <h1 style="color: #ff8c00; font-size: 4em; margin-bottom: 40px; text-shadow: 3px 3px 10px rgba(255, 140, 0, 0.8);">Login</h1>
    <form action="/login/loginSubmit" method="post">
        <div style="margin-bottom: 20px;">
            <label for="username" style="display: block; font-size: 1.2em; margin-bottom: 10px;">Email:</label>
        ...
        <div>
            <button type="submit" class="btn btn-primary"
                    style="font-size: 1.5em; padding: 20px 40px; margin: 15px; border-radius: 10px; cursor: pointer; transition: all 0.3s ease-in-out; color: white; background-color: #d9534f; border: none; box-shadow: 0px 4px 6px rgba(255, 69, 0, 0.5);">
                Login
            </button>
        </div>
        <p style="margin-top: 20px;">Don't have an account?
            <a href="/login/signup" style="color: #1976d2; text-decoration: none; font-weight: bold;">Sign up here</a>.
        </p>
    </form>
</div>
